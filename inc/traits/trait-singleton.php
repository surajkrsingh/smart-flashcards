...
namespace SMFCS\Features\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the SMFCS_features_singleton_init_{$called_class} hook to execute code
			 */
			do_action( sprintf( 'smfcs_features_singleton_init_%s', $called_class ) );
